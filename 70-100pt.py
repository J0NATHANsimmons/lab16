...
# Hints: use drawpad.delete(enemy) in the collision detect function, 
...
class myApp(object):
    ...
    def key(self,event):
        ...
        global drawpad
        if event.char == "w":
            drawpad.move(player,0,-20) #up
        elif event.char == "a":
                drawpad.move(player,-20,0) #left
        elif event.char == "s":
                drawpad.move(player,0,20)   #down
        elif event.char == "d":
                drawpad.move(player,20,0)  #right
